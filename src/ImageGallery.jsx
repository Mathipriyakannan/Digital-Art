 ...
 const firstContainerImages = [
  ...
  >
    ...
    >
      ...
      <header style={{marginRight:'20px',fontSize:"12px"}}><i class="bi bi-images"style={{marginRight:'5px',backgroundColor:'lightgreen',padding:'10px', color:'black',borderRadius:'60%' }}></i>Add your Artwork </header>
      ...
      <h1 style={{color:"white",marginLeft:'90px'}}>Digital art Work </h1>
      <div className='firstcon'>
 
       {/* First Container */}
    {renderImages(firstContainerImages, 'First Container', 'repeat(4, 1fr)',)}</div>
    <h1 style={{color:"white"}}>Recent Art</h1>
